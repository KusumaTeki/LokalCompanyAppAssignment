    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          {job.other_details || "No description provided."}
        </Text>
      </View>
    </ScrollView>
  );
...
const styles = StyleSheet.create({
  ...
  bookmarkContainer: {
    ...
    width: 30, // Fixed width for the container (adjust as needed)
    height: 30, // Fixed height for the container (adjust as needed)
